...
if __name__ == "__main__":
    ...
    file_list = os.listdir('C:/Users/user/warping/image')

    for file in file_list:
        print(file)
        filename = 'C:/Users/user/warping/image/'+file
        ori_img = cv2.imread(filename)
        resize_img = cv2.resize(ori_img, dsize=(1980, 1080), interpolation=cv2.INTER_AREA)  # 원래 사진이 4000x3000 이라서 사이즈 조절하였음.
        ...
        if checkpnt == 0:
            ...
            cv2.imwrite('C:/Users/user/warping/warping_image/'+file, result)
        else:
            pts = new_contour
